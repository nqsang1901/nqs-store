    ...
    <div class="slide-1 home-slider">
        ...
        <div>
            <a href="" class="home text-center">
                <img src="images/{{$slides->picture}}" alt="" class="bg-img blur-up lazyload">
            </a>
        </div>
        @endforeach
    </div>
                ...
                <div class="product-4 product-m no-arrow">
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="{{url('/'.($books->name).'.'.$books->id)}}">
                                    <img src="images/{{$books->picture}}" class="img-fluid blur-up lazyload bg-img"
                                        alt="product">
                                </a>
                            </div>
                        ...
                        <div class="product-detail">
                            ...
                            <h4 class="text-lowercase">{{$books->saleoff}} đ <del>{{$books->price}} đ</del></h4>
                        </div>
                    </div>
                    @endforeach
                </div>
