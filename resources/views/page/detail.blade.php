                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    <div class="product-slick">
                                        <div><img src="{{asset('images/'.$book->picture)}}" alt=""
                                ...
                                <div class="col-lg-8 col-xl-8 rtl-text">
                                    <div class="product-right">
                                        ...
                                        <h4><del>{{$book->price}} đ</del><span> -30%</span></h4>
                                        <h3>{{$book->saleoff}} đ</h3>
                        ...
                        <div class="theme-card">
                            ...
                            <div class="offer-slider slide-1">
                                ...
                                <div>
                                    ...
                                    <div class="media">
                                        <a href="item.html">
                                            <img class="img-fluid blur-up lazyload" src="images/product.jpg" alt="Cẩm Nang Cấu Trúc Tiếng Anh">
                                        </a>
